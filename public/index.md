...
> Example:
>
>     $ curl -H "Content-Type: application/json" -d '{"bio_ids": ["C000880", "A000360"]}' http://localhost:3000/retrieve-form-elements
...
>
>     $ curl -H "Content-Type: application/json" -d '{"bio_id": "A000000", "fields": {"$NAME_FIRST": "John", "$NAME_LAST": "Doe", "$ADDRESS_STREET": "123 Main Street", "$ADDRESS_CITY": "New York", "$ADDRESS_ZIP5": "10112", "$EMAIL": "joe@example.com", "$MESSAGE": "I have concerns about the proposal....", "$NAME_PREFIX": "Grand Moff"}}' http://localhost:3000/fill-out-form
>     {"status":"captcha_needed","url":"/captchas/e410e577123c5e19a526ad3f6b.png"}
>
> Example #2, no captcha:
>
>     $ curl -H "Content-Type: application/json" -d '{"bio_id": "A111111", "campaign_tag": "stop_sopa", "fields": {"$NAME_FIRST": "John", "$NAME_LAST": "Doe", "$ADDRESS_STREET": "123 Main Street", "$ADDRESS_CITY": "New York", "$ADDRESS_ZIP5": "10112", "$EMAIL": "joe@example.com", "$MESSAGE": "I have concerns about the proposal....", "$NAME_PREFIX": "Grand Moff"}}' http://localhost:3000/fill-out-form
>     {"status":"success"}
...
> Example for #1 above:
>
>     $ curl -H "Content-Type: application/json" -d '{"answer": "cx9bp", "uid": "example_uid"}' http://localhost:3000/fill-out-captcha
>     {"status":"success"}
...
>
>     $ curl 'http://localhost:3000/successful-fills-by-date/A000000?debug_key=some_key'
...
>
>     $ curl 'http://localhost:3000/successful-fills-by-date/A000000?campaign_tag=some_tag&debug_key=some_key'
...
>
>     $ curl 'http://localhost:3000/successful-fills-by-date/?debug_key=some_key'
...
>
>     $ curl 'http://localhost:3000/successful-fills-by-date/?campaign_tag=some_tag&debug_key=some_key'
...
>
>     $ curl 'http://localhost:3000/successful-fills-by-member/?debug_key=some_key'
>     {"A000000":312,"B000000":187,"C000000":103,"D000000":782,"E000000":41}
>
> Example with `campaign_tag`:
>
>     $ curl 'http://localhost:3000/successful-fills-by-member/?campaign_tag=some_tag&debug_key=some_key'
